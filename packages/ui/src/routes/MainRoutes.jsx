...
// AI Studio Knowledge Base routing
const KnowledgeBaseScrapLinks = Loadable(lazy(() => import('@/views/docstore/KnowledgeBaseScrapLinks')))
...
// Add blank page for Cogni-fuse
const Cognifuse = Loadable(lazy(() => import('@/views/cognifuse')))
const PromptManagement = Loadable(lazy(() => import('@/views/prompt management')))
const NewPrompt = Loadable(lazy(() => import('@/views/prompt management/newPrompt')))
