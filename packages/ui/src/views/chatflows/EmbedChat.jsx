...
const embedFullpageHtmlCode = (chatflowid) => {
    return `<cogniXcelerate-fullchatbot></cogniXcelerate-fullchatbot>
<script type="module">
    import Chatbot from "https://cdn.jsdelivr.net/npm/cognixcelerate-embed/dist/web.js"
    Chatbot.initFull({
        chatflowid: "${chatflowid}",
...
export const defaultThemeConfig = {
    ...
    chatWindow: {
        ...
        footer: {
            textColor: '#303235',
            text: 'Powered by',
            company: 'CogniXcelerate',
            companyLink: 'https://www.cogniwide.com/'
        }
    }
}
                            ...
                            <span>
                                ...
                                <p>
                                    ...
                                    <a
                                        rel='noreferrer'
                                        target='_blank'
                                        href='https://cdn.jsdelivr.net/npm/cognixcelerate-embed/dist/web.js'
                                    >
                                        version
                                    </a>
                                    :&nbsp;<code>{`https://cdn.jsdelivr.net/npm/cognixcelerate-embed/dist/web.js`}</code>
                                </p>
                            </span>
