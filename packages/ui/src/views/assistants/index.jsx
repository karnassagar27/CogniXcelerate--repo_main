...
const cards = [
    {
        ...
        description: 'Create custom assistant using your choice of LLMs with CogniXcelerate',
        icon: <IconRobotFace />,
        iconText: 'Custom',
        gradient: 'linear-gradient(135deg,rgba(164, 163, 66, 0.31) 0%, #ffcc802f 100%)'
    },
    {
        title: 'OpenAI Assistant',
        description: 'Create assistant using OpenAI Assistant API with CogniXcelerate',
    ...
    },
    {
        ...
        description: 'Create assistant using Azure Assistant API with CogniXcelerate',
        icon: <IconBrandAzure />,
        iconText: 'Azure',
            ...
            <MainCard>
                <Stack flexDirection='column' sx={{ gap: 3 }}>
                    <ViewHeader
                        ...
                        description='Chat assistants with instructions, tools, and files to respond to user queries with CogniXcelerate'
                    />
                    <FeatureCards />
                </Stack>
            </MainCard>
